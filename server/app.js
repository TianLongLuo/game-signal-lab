...
const FUNASR_DEFAULT_TIMEOUT_MS = 20_000;
...
const STATIC_ASSETS = new Map([
  ["/src/companion-stage.js", ["src/companion-stage.js", "text/javascript; charset=utf-8"]],
  ["/src/companion-scenes.js", ["src/companion-scenes.js", "text/javascript; charset=utf-8"]],
  ["/companion/guide/", ["companion/guide.html", "text/html; charset=utf-8"]],
  ...["cafe", "rain", "home", "coast", "garden"].map(name => [`/companion/scenes/${name}.jpg`, [`companion/scenes/${name}.jpg`, "image/jpeg"]]),
  ...
  ["/blog/zine-blog.css", ["blog/zine-blog.css", "text/css; charset=utf-8"]],
  ...
  ["/admin/", ["admin/index.html", "text/html; charset=utf-8"]],
  ["/admin/zine-system.css", ["admin/zine-system.css", "text/css; charset=utf-8"]],
  ...
  ["/assets/zine/signal-archive-v1.webp", ["assets/zine/signal-archive-v1.webp", "image/webp"]],
  ["/assets/zine/scene-archive-woman-silhouette.webp", ["assets/zine/scene-archive-woman-silhouette.webp", "image/webp"]],
  ["/assets/zine/scene-intake-dual-silhouette.webp", ["assets/zine/scene-intake-dual-silhouette.webp", "image/webp"]],
  ["/assets/zine/scene-agent-beach-silhouette.webp", ["assets/zine/scene-agent-beach-silhouette.webp", "image/webp"]],
  ...
  ["/privacy/privacy.css", ["privacy/privacy.css", "text/css; charset=utf-8"]],
  ["/en/privacy", ["en/privacy/index.html", "text/html; charset=utf-8"]],
  ["/en/privacy/", ["en/privacy/index.html", "text/html; charset=utf-8"]],
  ["/en/privacy/index.html", ["en/privacy/index.html", "text/html; charset=utf-8"]],
    ...
    if (method === "GET" && pathname === "/sitemap.xml") {
      ...
      sendText(
        ...
        [
          ...
          "  </url>",
          "  <url>",
          `    <loc>${publicOrigin}/privacy/</loc>`,
          "    <changefreq>monthly</changefreq>",
          "    <priority>0.5</priority>",
          "  </url>",
          "  <url>",
          `    <loc>${publicOrigin}/en/privacy/</loc>`,
          "    <changefreq>monthly</changefreq>",
          "    <priority>0.5</priority>",
          "  </url>",
          "  <url>",
      ...
      try {
        ...
        if (funAsr) {
          ...
          try {
            ...
            asrController.signal.throwIfAborted();
        ...
        const code = funAsrFailure ? funAsrFailureReason(funAsrFailure) : 'not_configured';
        throw new HttpError(code === 'timeout' ? 504 : 503, `asr_${code}`,
          code === 'timeout' ? '本地语音识别超时，请缩短录音后重试；录音未发送至云端。' :
          code === 'funasr_concurrency_limited' ? '本地语音识别正在处理其他录音，请稍后重试。' :
          '本地 FunASR 未配置或暂时不可用，请检查本地服务后重试；录音未发送至云端。');
      } finally {
...
async function transcribeWithFunAsrHttp({
  ...
  try {
    ...
    try {
      ...
      error.code = signal?.aborted ? "aborted" : controller.signal.aborted ? "timeout" : "protocol_error";
      error.cause = cause;
      throw error;
    }
  ...
  return new Promise((resolve, reject) => {
    ...
    const handleMessage = async (event) => {
      ...
      try {
        ...
        // is_final finalizes a VAD segment, not necessarily the recording.
