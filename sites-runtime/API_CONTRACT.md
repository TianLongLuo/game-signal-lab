...
Cloud speech synthesis, recognition and provider configuration have been removed.
Sites cannot reach the Linux loopback FunASR service: POST /api/voice/asr returns
503 asr_not_available without forwarding audio. Use the Linux deployment for
voice input. POST /api/voice/tts is unavailable. No cloud fallback is used.
